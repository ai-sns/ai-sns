...
"""
在数据库副本上添加真实执行例子
Add Real Execution Examples on Database Copy
"""
...
# 使用数据库副本
DB_PATH = "/root/sharedata3/ai-sns-el/db/db_with_examples.sqlite"
