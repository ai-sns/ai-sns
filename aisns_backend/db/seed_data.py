...
# Seed data for llm_config table (all non-deleted rows from reference database)
LLM_CONFIG_SEED = [
    {
        "config_id": "llm_e729a0c536f6",
...
# Seed data for role_config table (all non-deleted rows from reference database)
ROLE_CONFIG_SEED = [
    {
