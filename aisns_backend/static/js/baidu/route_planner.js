...
function getAllGpsPositions(routeResult) {
    ...
    //     url: 'http://localhost:8900/static/3d/mario6.glb',//'https://mapopen-pub-jsapi.bj.bcebos.com/jsapiGlgeo/img/bus.glb''http://localhost:8900/static/ybot.glb'http://localhost:8900/static/3d/mario3.glb,http://localhost:8900/static/3d/mario10.glb 15
    //     scale: 0.08,//9
    //     level: 18,
    //     rotationX: 100,//90
    //     rotationY: 180,//90
    ...
    movePoint = new Track.ModelPoint({ point: trackData[5].getPoint(), style:{
        url: 'https://mapopen-pub-jsapi.bj.bcebos.com/jsapiGlgeo/img/bus.glb',//'http://localhost:8900/static/ybot.glb'http://localhost:8900/static/3d/mario3.glb,http://localhost:8900/static/3d/mario10.glb 15
        scale: 9,
        level: 18,
        rotationX: 90,//90
        rotationY: 90,//90
