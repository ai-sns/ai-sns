                ...
                <div class="sns-map-area">
                    ...
                    <div class="map-container" id="mapContainer">
                        <div class="map-placeholder">
                            ...
                            <p class="map-placeholder-text">${window.escHtml(window.tt('sns.page.loadingMap'))}</p>
                    ...
                    <div class="map-action-bar">
                        ...
                        <div class="action-bar-state-1" id="actionBarState1">
                            <div class="action-bar-left">
                                <button class="action-btn" data-action="square" title="${window.escAttr(window.tt('sns.page.title.square'))}">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
                                        <polyline points="9 22 9 12 15 12 15 22"/>
                                    </svg>
                                    <span>${window.escHtml(window.tt('sns.page.btn.square'))}</span>
                                </button>
                                <button class="action-btn" data-action="ai" title="${window.escAttr(window.tt('sns.page.title.mc'))}">
...
<path d="M480-40 360-160H200q-33 0-56.5-23.5T120-240v-560q0-33 23.5-56.5T200-880h560q33 0 56.5 23.5T840-800v560q0 33-23.5 56.5T760-160H600L480-40ZM200-286q54-53 125.5-83.5T480-400q83 0 154.5 30.5T760-286v-514H200v514Zm379-235q41-41 41-99t-41-99q-41-41-99-41t-99 41q-41 41-41 99t41 99q41 41 99 41t99-41ZM280-240h400v-10q-42-35-93-52.5T480-320q-56 0-107 17.5T280-250v10Zm157.5-337.5Q420-595 420-620t17.5-42.5Q455-680 480-680t42.5 17.5Q540-645 540-620t-17.5 42.5Q505-560 480-560t-42.5-17.5ZM480-543Z"/>
                                    ...
                                    <span>${window.escHtml(window.tt('sns.page.btn.mc'))}</span>
                                </button>
                                <button class="action-btn" data-action="move" title="${window.escAttr(window.tt('sns.page.title.move'))}">
                                    ...
                                    <span>${window.escHtml(window.tt('sns.page.btn.move'))}</span>
                                </button>
                            </div>
                            <div class="action-bar-center">
                                <button class="action-btn-primary" id="snsStartBtn">
                                    ...
                                    <span>${window.escHtml(window.tt('sns.page.btn.start'))}</span>
                                </button>
                            </div>
                            <div class="action-bar-right">
                                <button class="action-btn" data-action="control" id="controlBtn" title="${window.escAttr(window.tt('sns.page.title.control'))}">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                                        <rect x="2" y="3" width="20" height="14" rx="2" ry="2"/>
                                        <line x1="8" y1="21" x2="16" y2="21"/>
                                        <line x1="12" y1="17" x2="12" y2="21"/>
                                    </svg>
                                    <span>${window.escHtml(window.tt('sns.page.btn.control'))}</span>
                                </button>
                                <button class="action-btn" data-action="plugin" title="${window.escAttr(window.tt('sns.page.title.plugin'))}">
                                    ...
                                    <span>${window.escHtml(window.tt('sns.page.btn.plugin'))}</span>
                                </button>
                                <button class="action-btn" data-action="help" title="${window.escAttr(window.tt('sns.page.title.help'))}">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                                        <circle cx="12" cy="12" r="10"/>
                                        <path d="M9.09 9a3 3 0 1 1 5.82 1c0 2-3 3-3 3"/>
                                        <line x1="12" y1="17" x2="12.01" y2="17"/>
                                    </svg>
                                    <span>${window.escHtml(window.tt('sns.page.btn.help'))}</span>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="action-bar-control-layout">
                                <div class="control-left-menu">
                                    ...
                                    <div class="control-dropdown" id="appsDropdown" style="display: none;">
                                        <button class="dropdown-item" data-action="square" title="${window.escAttr(window.tt('sns.page.title.square'))}">
                                        ...
                                        <button class="dropdown-item" data-action="ai" title="${window.escAttr(window.tt('sns.page.title.mc'))}">
<svg height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
<path d="M480-40 360-160H200q-33 0-56.5-23.5T120-240v-560q0-33 23.5-56.5T200-880h560q33 0 56.5 23.5T840-800v560q0 33-23.5 56.5T760-160H600L480-40ZM200-286q54-53 125.5-83.5T480-400q83 0 154.5 30.5T760-286v-514H200v514Zm379-235q41-41 41-99t-41-99q-41-41-99-41t-99 41q-41 41-41 99t41 99q41 41 99 41t99-41ZM280-240h400v-10q-42-35-93-52.5T480-320q-56 0-107 17.5T280-250v10Zm157.5-337.5Q420-595 420-620t17.5-42.5Q455-680 480-680t42.5 17.5Q540-645 540-620t-17.5 42.5Q505-560 480-560t-42.5-17.5ZM480-543Z"/>
</svg>
                                            <span>${window.escHtml(window.tt('sns.page.btn.mc'))}</span>
                                        </button>
                                        <button class="dropdown-item" data-action="move" title="${window.escAttr(window.tt('sns.page.title.move'))}">                                            
                                ...
                                <div class="control-center-input">
                                    <button class="control-computer-btn" id="computerBtn" title="${window.escAttr(window.tt('sns.page.title.endControl'))}">
                                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- Monitor frame -->
    <rect x="2" y="3" width="20" height="14" rx="2" ry="2"/>
    <line x1="8" y1="21" x2="16" y2="21"/>
    ...
    <line x1="15" y1="7" x2="9" y2="13"/>
                                    ...
                                    <div class="control-input-group">
                                        <div class="control-toggle-group">
                                            <span class="control-label">${window.escHtml(window.tt('sns.page.talkTo'))}</span>
                                            <div class="control-toggle-buttons">
                                                <button class="toggle-btn active" data-mode="ai" title="${window.escAttr(window.tt('sns.page.talkMcTitle'))}">${window.escHtml(window.tt('sns.page.talkMc'))}</button>
                                                <button class="toggle-btn" data-mode="friends" title="${window.escAttr(window.tt('sns.page.talkTcTitle'))}">${window.escHtml(window.tt('sns.page.talkTc'))}</button>
                                            </div>
                                        </div>
                                        <div class="control-input-wrapper">
                                            <input type="text" class="control-input" placeholder="${window.escAttr(window.tt('sns.page.inputPlaceholder'))}" title="${window.escAttr(window.tt('sns.page.inputTitle'))}" spellcheck="false" autocomplete="off" autocorrect="off" autocapitalize="off" />
                                ...
                                <div class="control-right-menu">
                                    ...
                                    <div class="control-dropdown control-dropdown-right" id="mapDropdown" style="display: none;">
                                        <button class="dropdown-item" data-action="help" title="${window.escAttr(window.tt('sns.page.title.help'))}">
                                            <span>${window.escHtml(window.tt('sns.page.btn.help'))}</span>
                                            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                                                <circle cx="12" cy="12" r="10"/>
                                                <path d="M9.09 9a3 3 0 1 1 5.82 1c0 2-3 3-3 3"/>
                                        ...
                                        <button class="dropdown-item" data-action="plugin" title="${window.escAttr(window.tt('sns.page.title.plugin'))}">
                                            <span>${window.escHtml(window.tt('sns.page.btn.plugin'))}</span>
                                            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M19.439 7.85c.157-.24.245-.525.245-.814V3a1 1 0 0 0-1-1h-3.95c-.289 0-.574.088-.814.245a2.5 2.5 0 1 1-3.84 0A1.5 1.5 0 0 0 9.266 2H5.316a1 1 0 0 0-1 1v3.95c0 .289-.088.574-.245.814a2.5 2.5 0 1 1 0 3.84c.157.24.245.525.245.814V20a1 1 0 0 0 1 1h3.95c.289 0 .574-.088.814-.245a2.5 2.5 0 1 1 3.84 0c.24.157.525.245.814.245h3.95a1 1 0 0 0 1-1v-3.95c0-.289.088-.574.245-.814a2.5 2.5 0 1 1 0-3.84Z"/>
                                            </svg>
                ...
                <div class="sns-panel-resizer" id="snsPanelResizer">
                    ...
                    <button class="panel-collapse-btn" id="snsPanelCollapseBtn" title="${window.escAttr(window.tt('sns.page.title.collapsePanel'))}">
                ...
                <div class="sns-status-panel" id="snsStatusPanel">
                    ...
                    <div class="status-search-bar" id="statusSearchBar" style="display: none;">
                        <div class="search-input-wrapper">
                            ...
                            <input type="text" class="search-input" id="statusSearchInput" placeholder="${window.escAttr(window.tt('sns.page.searchTabPlaceholder'))}">
                            <button class="search-clear-btn" id="statusSearchClear" title="${window.escAttr(window.tt('sns.page.title.closeSearch'))}">
                        ...
                        <div class="search-results-info" id="searchResultsInfo" style="display: none;">
                            <span id="searchResultsText">${window.escHtml(window.tt('sns.page.foundResults'))}</span>
                            <div class="search-navigation">
                                <button class="search-nav-btn" id="searchPrevBtn" title="${window.escAttr(window.tt('sns.page.title.previous'))}">
                                    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
                                        <polyline points="15 18 9 12 15 6"/>
                                    </svg>
                                </button>
                                <button class="search-nav-btn" id="searchNextBtn" title="${window.escAttr(window.tt('sns.page.title.next'))}">
                                    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="status-context-menu" id="statusContextMenu" style="display: none;">
                        <button class="context-menu-item" data-action="copy">
                            ...
                            <span>${window.escHtml(window.tt('sns.page.ctx.copy'))}</span>
                        </button>
                        <button class="context-menu-item" data-action="selectAll">
                            ...
                            <span>${window.escHtml(window.tt('sns.page.ctx.selectAll'))}</span>
                        </button>
                        ...
                        <button class="context-menu-item" data-action="search">
                            ...
                            <span>${window.escHtml(window.tt('sns.page.ctx.search'))}</span>
                        </button>
                    </div>
                        ...
                        <div class="tab-pane" data-tab="think">
                            <div class="status-section">
                                <div class="status-section-title">
                                    ...
                                    ${window.escHtml(window.tt('sns.page.section.aiModel'))}
                                    <button class="refresh-btn" id="refreshModelInfoBtn" title="${window.escAttr(window.tt('sns.page.title.refreshModel'))}">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="status-tabs" id="statusTabs">
                        <button class="status-tab active" data-tab="process">${window.escHtml(window.tt('sns.page.tab.process'))}</button>
                        <button class="status-tab" data-tab="resource">${window.escHtml(window.tt('sns.page.tab.resource'))}</button>
                        <button class="status-tab" data-tab="think">${window.escHtml(window.tt('sns.page.tab.think'))}</button>
                    </div>
                </div>
            </div>
        `;
    ...
    async loadModelInfo() {
        try {
            ...
            if (result.success && result.data) {
                ...
                const na = ' ' + (window.tt ? window.tt('sns.page.na') : 'N/A');
                if (agentValue) agentValue.textContent = na;
                if (providerValue) providerValue.textContent = na;
                if (modelValue) modelValue.textContent = na;
            }
        } catch (error) {
            ...
            const err = ' ' + (window.tt ? window.tt('sns.page.error') : 'Error');
            if (agentValue) agentValue.textContent = err;
            if (providerValue) providerValue.textContent = err;
            if (modelValue) modelValue.textContent = err;
        }
    }
};
