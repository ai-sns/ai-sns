...
#****add the code to register_model_client*******
@dataclass
class GroupChat:
    ...
    def _auto_select_speaker(
        ...
        llm_client = speaker_selection_agent.llm_config["config_list"][0].get("model_client_cls","OpenAI")

        if llm_client !="OpenAI":
            speaker_selection_agent.register_model_client(model_client_cls=OpenAICompatibleLLMClient)#cjr todo
