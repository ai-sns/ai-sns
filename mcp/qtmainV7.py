...
class MCPClientWorker(QObject):
    ...
    shutdown_complete = pyqtSignal()  # 新增：关闭完成信号
    ...
    def __init__(self, server_script_path: str):
        ...
        self._running = False
        self._exit_stack: Optional[AsyncExitStack] = None  # 资源管理堆栈
    ...
    def stop(self):
        ...
        # 安全关闭连接和资源
        if self._exit_stack:
            asyncio.run_coroutine_threadsafe(self._close_resources(), self.loop)
    ...
    async def _close_resources(self):
        ...
        try:
            ...
            self.error_occurred.emit(f"资源关闭错误: {str(e)}")
        finally:
...
class MainWindow(QMainWindow):
    ...
    def connect_signals(self):
        ...
        self.worker.shutdown_complete.connect(self.on_worker_shutdown)  # 新增
    ...
    def closeEvent(self, event):
        ...
        if hasattr(self, 'worker_thread') and self.worker_thread.isRunning():
            ...
            #     self.status_display.append("强制终止工作线程...")
            #     self.worker_thread.terminate()
