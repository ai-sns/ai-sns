    ...
    function animate(time) {
        //requestAnimationFrame is a browser api,it will provide a timestamp for the function as a parameter
    ...
    function load_aisns_building() {
        ...
        const coordinates = {
            lng: -73.97443036231587, lat: 40.77062439461379,
        };

        const position2 = overlay.latLngAltitudeToVector3(coordinates, mesh.position);
        console.log("position2vv", position2)
        console.log("model.positionvvv", mesh.position)
        console.log("model.positionvvvx", mesh.position.x)
        console.log("model.positionvvvz", mesh.position.z)
        ...
        overlay.scene.add(mesh); // 将模型添加到场景中
