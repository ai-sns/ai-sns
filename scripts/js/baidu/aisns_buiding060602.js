...
function load_aisns_building() {
    ...
    building_model = new BMapGL.ThreeLayer({
        enablePicked: true,
        antialias: true,
        onInit: function (renderer, scene, camera) {
            ...
            var result = building_model.customCoords([[121.44690152307729, 31.25875179971229]]);
            // alert(result[0][0]);
    ...
    building_model.addEventListener('click', function (e) {
    ...
    map.addNormalLayer(building_model);
