...
import json
from util import generate_random_id, extract_json_string_from_llm, convert_unicode_to_chinese,add_memory_list,add_memory_single
...
class Ui_TaskPageWidget(object):
    ...
    def setupUi(self, TaskWidget):
        ...
        self.delete_batch_button.setText(lt("Delete", "删除"))
        ...
        self.shareButton.setText(lt("Share", "转发"))
        ...
        self.collectButton.setIcon(QtGui.QIcon("images/save.png"))
        self.collectButton.setObjectName("collectButton")
        self.collectButton.setText(lt("Save as", "另存为"))
        ...
        self.messageEdit.setPlaceholderText(lt("Input @@ to load tools selector; Ctrl+i To load preset question; Ctrl+/ To insert chat template.", "以@@开头可调用工具选择框;Ctrl+i可加载预设信息;Ctrl+/可插入对话模板Ctrl+/可插入对话模板"))
    ...
    def collect_message(self, data_id, message=""):
        ...
        transfer_dialog = QDialog()
        transfer_dialog.setWindowTitle(lt("Save as","另存为"))
        ...
        radio_memory = QRadioButton(lt("Memory", "记忆"))
        ...
        radio_layout.addWidget(radio_memory)
        ...
        form_layout.addRow("另存至笔记：", transfer_dialog.comboBox)
        ...
        def add_to_memory(message):
            try:
                add_memory_single(message)
            except Exception as e:
                QMessageBox.critical(self, "Error", f"Failed to add to memory: {e}")
