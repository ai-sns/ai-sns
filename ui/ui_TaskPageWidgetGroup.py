...
class Ui_TaskPageWidget(object):
    ...
    def setupUi(self, TaskWidget):
        ...
        left_layout.addItem(spacerItem_label_left)  # 通过留空来居中
        ...
        self.title_labela2.setVisible(False)
        self.model_combobox.setVisible(False)
        self.role_label.setVisible(False)
        self.prompt_combobox.setVisible(False)
        ...
        self.tabWidget.addTab(self.tab_models, lt("Compare", "多模型"))
        ...
        self.plugin_button.setVisible(False)
        ...
        self.kmButton.setVisible(False)
        ...
        self.task_button.setVisible(False)
        ...
        self.messageEdit.setPlaceholderText(lt("Ctrl+Enter To send message","Ctrl+Enter发送信息"))
    ...
    def retranslateUi(self, TaskWidget):
        ...
        self.speaker.on_message_show_group_select_agent_title.connect(self.show_group_select_agent_title)
