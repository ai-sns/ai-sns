...
class Ui_TaskPageWidget(object):
    def setupUi(self, TaskWidget):
        ...
        self.messageEdit.setPlaceholderText("Ctrl+/可以插入当前角色的对话模板,点击模型、角色标签可切换模型和角色")
        ...
        self.frame_bottom.setStyleSheet("QFrame { border: 1px solid #c0c0c0;border-radius: 8px;}")
