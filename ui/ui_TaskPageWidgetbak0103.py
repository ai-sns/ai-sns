...
from qtpy.QtCore import Qt, QMetaObject, pyqtSignal, Slot, QEvent
...
from PyQt6.QtCore import Slot, Qt, QUrl, QFileInfo, Property
...
class MessageHandler(QWidget):
    ...
    thevalue = Property(str, fget=PyQt52WebValue, fset=Web2PyQt5Value)
...
class Ui_TaskPageWidget(object):
    ...
    def setupUi(self, TaskWidget):
        ...
        self.frame_bottom.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
    ...
    def transfer_message_to_workflow(self, workflow_json_str):
        ...
        add_workflow_mng(workflow_id=workflow_id, title=title, description=desc, instruction=selected_label, detail=detail, timer_desc="", timer_cron="")
