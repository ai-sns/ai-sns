...
from PyQt6.QtWebEngineWidgets import QWebEnginePage, QWebEngineFullScreenRequest, QWebEngineView, QWebEngineProfile
from PyQt6.QtWidgets import QLabel, QCheckBox, QComboBox

from qtpy.QtCore import Qt, QMetaObject, pyqtSignal, pyqtSlot, QEvent
...
class Ui_TaskPageWidget(object):
    def setupUi(self, TaskWidget):
        ...
        spacerItem_label_left = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        spacerItem_label_right = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
