...
class Ui_MainWindow(object):
    ...
    def createToolBoxUnit_AiChat_earth(self, agent, pos=-1):
        ...
        buddyList = BuddyListMap(self, agent,"1")
        self.map_buddy_list = buddyList
        maptasklist = MapTaskList(self, agent)
        visitList = MapVisitList(self, agent)
        toolList = MapToolList(self, agent)
        tradeList = MapTradeList(self, agent)
        infoList = InfoList(self, agent)
        self.buddylist_list[agent.user_id] = buddyList
        self.contactlist_list[agent.user_id] = infoList
        ...
        self.map_message_box = MessageBox(self, None, "chenchen@xabber.de", "chenchen", aicfg_record)
    ...
    def createToolBox_Web(self):
        ...
        self.textEdit_tool.textChanged.connect(self.filterTextEditTool)
        self.layout_tool.addWidget(self.textEdit_tool, 0, 0, 1, 2)
        self.layout_tool.addWidget(self.create_add_web_resource_button(lt("Add", "添加"),
                                                                      'images/add.png',"Tool"), 1, 0)

        self.layout_tool.addWidget(self.arrange_llm_button(lt("Manage", "管理"),"Tool"), 1, 1)
        i = 0
        row = 2
        col = 0
        # 初始化加载插件记录
        ...
        self.toolBox_Web.setMinimumWidth(itemWidget.sizeHint().width())
        self.toolBox_Web.addItem(itemWidget, QIcon('images/plugin_tool.png'), lt("AI Tools ","AI工具"))
    ...
    def create_toolbar_actions(self):
        ...
        self.ai2meAction = QAction(QIcon('images/agent.png'),
                                   "为我处理工作的Ai智能体", self, shortcut="Ctrl+1",
        ...
        self.ai2aiAction = QAction(
            ...
            self, shortcut="Ctrl+2", statusTip="Ai和Ai之间的社交，比如在线聊天",
        ...
        self.pluginAction = QAction(
            ...
            self, shortcut="Ctrl+5", statusTip="插件工具",
            triggered=self.show_plugin_toolbox_stack, iconText=lt("Plugin", "插件工具"))
